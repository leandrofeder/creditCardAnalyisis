...
function categorize(title) {
  ...
  if(t.includes("fitland")||t.includes("koch")||t.includes("supermercado")||t.includes("rede top")||t.includes("sams club")||t.includes("superferreira")||t.includes("hipermercado")||t.includes("cooper")||t.includes("mercado garcia")||t.includes("cs koch")||t.includes("atacadao")||t.includes("carrefour")) return "Supermercado";
  ...
  if(t.includes("restaurante")||t.includes("hipermercado")||t.includes("lanchonete")||t.includes("pizz")||t.includes("burger")||t.includes("sushi")||t.includes("churrascaria")||t.includes("bar ")||t.includes("grill")||t.includes("aromata")||t.includes("alemaobatata blumenau")) return "Gastronomia";
  if(t.includes("ifood")||t.includes("rappi")||t.includes("delivery")||t.includes("uber eats")||t.includes("ifd")) return "Delivery";
  if(t.includes("padaria")||t.includes("confeitaria")||t.includes("pao ")||t.includes("bakery")||t.includes("papicori")||t.includes("portus")) return "Padaria/Alimentação";
  ...
  if(t.includes("bazar")||t.includes("reuter")||t.includes("tecnofesta")||t.includes("milium")||t.includes("cacau")||t.includes("oboticario")||t.includes("havan")) return "Presentes/Bazar";
